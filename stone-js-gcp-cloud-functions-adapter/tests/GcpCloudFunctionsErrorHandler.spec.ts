import { GcpCloudFunctionsErrorHandler } from '../src/GcpCloudFunctionsErrorHandler'
import { AdapterErrorContext, ILogger, IBlueprint } from '@stone-js/core'

describe('GcpCloudFunctionsErrorHandler', () => {
  let mockLogger: ILogger
  let mockBlueprint: IBlueprint
  let handler: GcpCloudFunctionsErrorHandler
  ...
  beforeEach(() => {
    ...
    handler = new GcpCloudFunctionsErrorHandler({ blueprint: mockBlueprint })
  })
