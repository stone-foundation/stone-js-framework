...
[![npm license](https://img.shields.io/npm/l/@stone-js/gcp-cloud-functions-http-adapter)](https://opensource.org/licenses/MIT)
[![npm version](https://img.shields.io/npm/v/@stone-js/gcp-cloud-functions-http-adapter)](https://www.npmjs.com/package/@stone-js/gcp-cloud-functions-http-adapter)
[![npm downloads](https://img.shields.io/npm/dm/@stone-js/gcp-cloud-functions-http-adapter)](https://www.npmjs.com/package/@stone-js/gcp-cloud-functions-http-adapter)
