...
const modules: ModuleInfo[] = [
  ...
  { package: '@stone-js/mcp-adapter', summary: 'Expose your domain to AI agents as MCP tools.', tier: 'adapter' },
  ...
  { package: '@stone-js/mcp', summary: 'Agent-native framework map: MCP tools + llms.txt.', tier: 'extension' },
