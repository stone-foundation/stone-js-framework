...
import { AzureHttpRequest, AzureHttpResponseInit, AzureFunctionsHttpExecutionContext, AzureFunctionsHttpAdapterResponseBuilder } from './declarations'
import {
  ILogger,
  IBlueprint,
  LoggerResolver,
 ...
 */
export class AzureFunctionsHttpErrorHandler implements IAdapterErrorHandler<AzureHttpRequest, AzureHttpResponseInit, AzureFunctionsHttpExecutionContext> {
   ...
   */
  handle (error: Error, context: AdapterErrorContext<AzureHttpRequest, AzureHttpResponseInit, AzureFunctionsHttpExecutionContext>): AdapterEventBuilderType<AzureHttpResponseInit> {
    ...
    return (context.rawResponseBuilder as unknown as AzureFunctionsHttpAdapterResponseBuilder)
