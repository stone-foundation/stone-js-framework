...
describe('TencentScfHttpAdapter', () => {
  let blueprint: IBlueprint
  let adapter: TencentScfHttpAdapter
  ...
  beforeEach(() => {
    ...
    adapter = TencentScfHttpAdapter.create(blueprint)
  })
  ...
  it('should throw in browser environment when run is called', async () => {
    ...
    await expect(adapter.run()).rejects.toThrow(TencentScfHttpAdapterError)
