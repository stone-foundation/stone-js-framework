...
import { TencentScfHttpErrorHandler } from '../src/TencentScfHttpErrorHandler'
...
describe('TencentScfHttpErrorHandler', () => {
  let mockLogger: ILogger
  let mockBlueprint: IBlueprint
  let handler: TencentScfHttpErrorHandler
  ...
  beforeEach(() => {
    ...
    handler = new TencentScfHttpErrorHandler({ blueprint: mockBlueprint })
  })
