...
/**
 * TencentScfHttpErrorHandler options.
 */
export interface TencentScfHttpErrorHandlerOptions {
  blueprint: IBlueprint
}

/**
 * Class representing an TencentScfHttpErrorHandler.
 */
export class TencentScfHttpErrorHandler implements IAdapterErrorHandler<TencentScfHttpEvent, RawHttpResponse, TencentScfContext> {
   ...
   */
  constructor ({ blueprint }: TencentScfHttpErrorHandlerOptions) {
  ...
  public handle (
    error: Error,
    context: AdapterErrorContext<TencentScfHttpEvent, RawHttpResponse, TencentScfContext>
