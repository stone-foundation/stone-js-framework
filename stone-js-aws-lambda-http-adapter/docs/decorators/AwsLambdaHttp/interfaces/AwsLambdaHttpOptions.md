...
```ts
optional errorHandlers?: Record<string, MetaAdapterErrorHandler<AwsLambdaHttpEvent, RawHttpResponseOptions, AwsLambdaContext>>;
```
...
```ts
optional middleware?: AdapterMixedPipeType<AdapterContext<AwsLambdaHttpEvent, RawHttpResponseOptions, AwsLambdaContext, IncomingHttpEvent, IncomingHttpEventOptions, OutgoingHttpResponse>, RawHttpResponseOptions>[];
```
