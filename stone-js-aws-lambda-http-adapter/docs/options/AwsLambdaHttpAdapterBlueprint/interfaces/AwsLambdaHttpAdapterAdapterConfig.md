...
```ts
middleware: AdapterMixedPipeType<AdapterContext<AwsLambdaHttpEvent, RawHttpResponseOptions, AwsLambdaContext, IncomingHttpEvent, IncomingHttpEventOptions, OutgoingHttpResponse>, RawHttpResponseOptions>[];
```
