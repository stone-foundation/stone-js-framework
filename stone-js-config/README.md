...
[![npm license](https://img.shields.io/npm/l/@stone-js/config)](https://opensource.org/licenses/MIT)
[![npm version](https://img.shields.io/npm/v/@stone-js/config)](https://www.npmjs.com/package/@stone-js/config)
[![npm downloads](https://img.shields.io/npm/dm/@stone-js/config)](https://www.npmjs.com/package/@stone-js/config)
...
See [CONTRIBUTING.md](https://github.com/stone-foundation/stone-js-framework/blob/main/CONTRIBUTING.md)
