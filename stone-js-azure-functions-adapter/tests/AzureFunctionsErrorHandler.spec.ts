import { AzureFunctionsErrorHandler } from '../src/AzureFunctionsErrorHandler'
import { AdapterErrorContext, ILogger, IBlueprint } from '@stone-js/core'

describe('AzureFunctionsErrorHandler', () => {
  let mockLogger: ILogger
  let mockBlueprint: IBlueprint
  let handler: AzureFunctionsErrorHandler
  ...
  beforeEach(() => {
    ...
    handler = new AzureFunctionsErrorHandler({ blueprint: mockBlueprint })
  })
