...
- ec1af7b: fix(cli): replace the deprecated vite-plugin-babel `filter` option with `include`/`exclude` (removes the SPA build warning on vite-plugin-babel >= 1.7).
- Updated dependencies [3308197]
  - @stone-js/core@1.0.0
  - @stone-js/filesystem@1.0.0
  - @stone-js/node-cli-adapter@1.0.0
  - @stone-js/router@1.0.0
  - @stone-js/use-react@1.0.0
  - @stone-js/pipeline@1.0.0
