...
import { HeadContext, IPageLayout, PageLayout, PageLayoutRenderContext, StoneOutlet } from '@stone-js/use-react'
...
export class SiteLayout implements IPageLayout {
  /** Brand-default social card. Each page's own `head()` is merged on top (page wins). */
  head (): HeadContext {
