...
function DocShell ({ children }: { children: ReactNode }): JSX.Element {
  ...
  // Restore the persisted theme on mount (paradigm is restored by ParadigmSwitch).
  useEffect(() => {
    try {
    ...
    <div className={`docs-root ${drawer ? 'drawer-open' : ''}`}>
      ...
      <header className='docs-header'>
        <div className='dh-inner'>
          ...
          <a className='icon-btn' href={GITHUB_URL} target='_blank' rel='noopener noreferrer' aria-label='GitHub' title='GitHub'>
