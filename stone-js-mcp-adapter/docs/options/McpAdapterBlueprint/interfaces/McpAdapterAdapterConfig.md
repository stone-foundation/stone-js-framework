...
[McpAdapter](../../../README.md) / [options/McpAdapterBlueprint](../README.md) / McpAdapterAdapterConfig

# Interface: McpAdapterAdapterConfig

Adapter configuration for the MCP adapter.

## Extends

- `AdapterConfig`\<`IncomingEvent`, `OutgoingResponse`, [`McpExecutionContext`](../../../declarations/type-aliases/McpExecutionContext.md), `IncomingEvent`, `IncomingEventOptions`, `OutgoingResponse`\>
...
> **middleware**: `AdapterMixedPipeType`\<`AdapterContext`\<`IncomingEvent`, `OutgoingResponse`, [`McpExecutionContext`](../../../declarations/type-aliases/McpExecutionContext.md), `IncomingEvent`, `IncomingEventOptions`, `OutgoingResponse`\>, `OutgoingResponse`\>[]
