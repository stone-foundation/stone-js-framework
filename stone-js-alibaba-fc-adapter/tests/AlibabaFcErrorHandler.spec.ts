import { AlibabaFcErrorHandler } from '../src/AlibabaFcErrorHandler'
import { AdapterErrorContext, ILogger, IBlueprint } from '@stone-js/core'

describe('AlibabaFcErrorHandler', () => {
  let mockLogger: ILogger
  let mockBlueprint: IBlueprint
  let handler: AlibabaFcErrorHandler
  ...
  beforeEach(() => {
    ...
    handler = new AlibabaFcErrorHandler({ blueprint: mockBlueprint })
  })
