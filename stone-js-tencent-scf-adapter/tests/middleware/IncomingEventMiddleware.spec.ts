...
import { TencentScfAdapterError } from '../../src/errors/TencentScfAdapterError'
import { IncomingEventMiddleware } from '../../src/middleware/IncomingEventMiddleware'
import { TencentScfAdapterContext, TencentScfAdapterResponseBuilder } from '../../src/declarations'

describe('IncomingEventMiddleware', () => {
  let middleware: IncomingEventMiddleware
  let mockContext: TencentScfAdapterContext
  let next: NextMiddleware<TencentScfAdapterContext, TencentScfAdapterResponseBuilder>
  ...
  beforeEach(() => {
    ...
    } as unknown as TencentScfAdapterContext
  ...
  it('should throw error if context is missing rawEvent or incomingEventBuilder', async () => {
    ...
    await expect(middleware.handle(mockContext, next)).rejects.toThrow(TencentScfAdapterError)
