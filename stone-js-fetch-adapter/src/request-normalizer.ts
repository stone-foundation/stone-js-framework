...
/** Header names carrying the client IP, in order of preference (covers CF, Vercel, Deno, generic). */
 ...
 */
export async function readRawBody (request: Request): Promise<string | Uint8Array | undefined> {
 ...
 */
export async function normalizeRequest (request: Request): Promise<NormalizedRequest> {
